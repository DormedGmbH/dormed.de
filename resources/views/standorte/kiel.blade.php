...
<div style="position:relative;pointer-events:auto;cursor:default;opacity:1;transition:opacity 0.2s ease;display:block;overflow:visible;width:100%;height:auto;min-height:auto"><section id="section-sec-airdpj2pm" style="position:relative;width:100%;min-height:auto;background-color:#F7F5F0;background-image:none;border-style:none;border-width:0;border-color:transparent;border-radius:0px;padding-top:0px;padding-bottom:0px;padding-left:0px;padding-right:0px;display:flex;flex-direction:column;justify-content:flex-start;align-items:center;box-sizing:border-box;z-index:1;overflow:visible;transition:min-height 0.2s ease"><div style="position:relative;pointer-events:auto;cursor:default;opacity:1;transition:opacity 0.2s ease;display:block;overflow:visible;width:100%;height:auto;min-height:auto"><div id="container-con-gnz4g09cn" style="width:100%;max-width:9999px;margin:0 auto;padding-top:0px;padding-bottom:0px;padding-left:0px;padding-right:0px;background-color:transparent;background-image:none;border-style:none;border-width:0;border-color:transparent;border-radius:0px;box-sizing:border-box;min-height:0px;display:flex;flex-direction:row;gap:0px;justify-content:center;align-items:center;transition:all 0.2s ease, box-shadow 0.2s ease, filter 0.2s ease, backdrop-filter 0.2s ease"><div style="position:relative;pointer-events:auto;cursor:default;opacity:1;transition:opacity 0.2s ease;display:block;overflow:visible;width:100%;height:auto;min-height:auto"><div id="widget-el-9jz88gogc" class="widget-root full-width" style="width:100%;height:auto;padding:0px;box-sizing:border-box;display:flex;flex-direction:column;position:relative"><style>
          #widget-el-9jz88gogc { width: 100% !important; display: flex; }
...
<div class="std-hero__wrap">
  ...
  <div class="std-hero__topbar" id="std-tb">
    <nav class="std-hero__topbar-crumb" aria-label="Breadcrumb">
      ...
      <span class="std-hero__topbar-crumb-sep">›</span>
      <span class="std-hero__topbar-crumb-current">Kiel</span>
    </nav>
  ...
  <div class="std-hero__main">
    ...
    <div class="std-hero__left">
      <div class="std-hero__bg-initial" aria-hidden="true">K</div>
      <div class="std-hero__left-content">

        <div class="std-hero__eyebrow" id="std-ey">
          <div class="std-hero__eyebrow-line"></div>
          <span class="std-hero__eyebrow-text">SONORING DORMED · Standort Kiel</span>
        </div>

        <h1 class="std-hero__h1" id="std-h1">
          Kiel
          <span>Ultraschall-Sonothek Kiel</span>
        </h1>
        ...
        <div class="std-hero__ctas" id="std-cta">
          ...
          <a href="https://maps.google.com/?q=Maria-Merian-Straße+9+24145+Kiel" class="std-hero__btn std-hero__btn--outline">Route planen</a>
        </div>
  ...
  <div class="std-hero__strip" id="std-strip">
    <div class="std-hero__strip-item">
      ...
      <span class="std-hero__strip-text">Standort <strong>Kiel</strong></span>
    </div>
    <div class="std-hero__strip-item">
      <span class="std-hero__strip-dot"></span>
...
<div style="position:relative;pointer-events:auto;cursor:default;opacity:1;transition:opacity 0.2s ease;display:block;overflow:visible;width:100%;height:auto;min-height:auto"><section id="section-sec-7rj9a18s7" style="position:relative;width:100%;min-height:auto;background-color:#FFFFFF;background-image:none;border-style:none;border-width:0;border-color:transparent;border-radius:0px;padding-top:0px;padding-bottom:0px;padding-left:0px;padding-right:0px;display:flex;flex-direction:column;justify-content:flex-start;align-items:center;box-sizing:border-box;z-index:1;overflow:visible;transition:min-height 0.2s ease"><div style="position:relative;pointer-events:auto;cursor:default;opacity:1;transition:opacity 0.2s ease;display:block;overflow:visible;width:100%;height:auto;min-height:auto"><div id="container-con-t8kshpt8r" style="width:100%;max-width:9999px;margin:0 auto;padding-top:0px;padding-bottom:0px;padding-left:0px;padding-right:0px;background-color:transparent;background-image:none;border-style:none;border-width:0;border-color:transparent;border-radius:0px;box-sizing:border-box;min-height:0px;display:flex;flex-direction:row;gap:0px;justify-content:center;align-items:center;transition:all 0.2s ease, box-shadow 0.2s ease, filter 0.2s ease, backdrop-filter 0.2s ease"><div style="position:relative;pointer-events:auto;cursor:default;opacity:1;transition:opacity 0.2s ease;display:block;overflow:visible;width:100%;height:auto;min-height:auto"><div id="widget-el-0k3wpjlaa" class="widget-root full-width" style="width:100%;height:auto;padding:0px;box-sizing:border-box;display:flex;flex-direction:column;position:relative"><style>
          #widget-el-0k3wpjlaa { width: 100% !important; display: flex; }
        </style><div style="pointer-events:auto;width:100%;display:block"><div class="custom_code_wrapper"><div class="custom_code_container"><style>
.std-team__wrap {
  font-family: 'Space Grotesk', sans-serif;
  -webkit-font-smoothing: antialiased;
...
<div class="std-team__wrap">
  <div class="std-team__inner">
    ...
    <div class="std-team__header" id="std-tm-hdr">
      ...
      <h2 class="std-team__h2">Ihr Team in <span>Kiel</span></h2>
      <p class="std-team__h2-sub">Ihr Ansprechpartner für Beratung und Service in Schleswig-Holstein.</p>
    </div>
    ...
    <div class="std-team__grid" id="std-tm-grid">
      ...
      <div class="std-team__member">
        <div class="std-team__photo-wrap">
          <img class="std-team__photo"
            src="/assets/img/75ff0d00-54b6-424b-d0d2-1710503e4800.jpg"
            alt="Folke Johannsen, Medical Service Support"
            loading="lazy"
          />
          <span class="std-team__dept-badge">Service</span>
        </div>
        <div class="std-team__info">
          <span class="std-team__name">Folke Johannsen</span>
          <span class="std-team__role">Medical Service Support</span>
          <div class="std-team__contacts">
            <a href="tel:01743353633" class="std-team__contact">
              <svg viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.65 3.35 2 2 0 0 1 3.62 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.6a16 16 0 0 0 6 6l.92-.92a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.73 16z"/></svg>
              01522 / 60 13 865
            </a>
            <a href="mailto:a.draheim@dormed.de" class="std-team__contact">
...
<div style="position:relative;pointer-events:auto;cursor:default;opacity:1;transition:opacity 0.2s ease;display:block;overflow:visible;width:100%;height:auto;min-height:auto"><section id="section-sec-vek8kyo1k" style="position:relative;width:100%;min-height:auto;background-color:#F4F6F9;background-image:none;border-style:none;border-width:0;border-color:transparent;border-radius:0px;padding-top:0px;padding-bottom:0px;padding-left:0px;padding-right:0px;display:flex;flex-direction:column;justify-content:flex-start;align-items:center;box-sizing:border-box;z-index:1;overflow:visible;transition:min-height 0.2s ease"><div style="position:relative;pointer-events:auto;cursor:default;opacity:1;transition:opacity 0.2s ease;display:block;overflow:visible;width:100%;height:auto;min-height:auto"><div id="container-con-9sshzk9v7" style="width:100%;max-width:9999px;margin:0 auto;padding-top:0px;padding-bottom:0px;padding-left:0px;padding-right:0px;background-color:transparent;background-image:none;border-style:none;border-width:0;border-color:transparent;border-radius:0px;box-sizing:border-box;min-height:0px;display:flex;flex-direction:row;gap:0px;justify-content:center;align-items:center;transition:all 0.2s ease, box-shadow 0.2s ease, filter 0.2s ease, backdrop-filter 0.2s ease"><div style="position:relative;pointer-events:auto;cursor:default;opacity:1;transition:opacity 0.2s ease;display:block;overflow:visible;width:100%;height:auto;min-height:auto"><div id="widget-el-j6snh1ldl" class="widget-root full-width" style="width:100%;height:auto;padding:0px;box-sizing:border-box;display:flex;flex-direction:column;position:relative"><style>
          #widget-el-j6snh1ldl { width: 100% !important; display: flex; }
        </style><div style="pointer-events:auto;width:100%;display:block"><div class="custom_code_wrapper"><div class="custom_code_container"><style>
.std-area__wrap {
  --navy:   rgb(9,58,126);
  --blue:   rgb(11,95,183);
...
<div class="std-area__inner">
  ...
  <div class="std-area__head std-area__anim">
    <div class="std-area__head-left">
      ...
      <h2 class="std-area__h2">An der <em>Ostseeküste</em></h2>
    </div>
    <p class="std-area__intro">Unser nördlichster Standort liegt im Kieler Wissenschaftspark. Von hier aus betreuen wir ganz Schleswig-Holstein — von Flensburg bis Lübeck, von der Nordsee- bis zur Ostseeküste.</p>
  </div>

  <!-- STANDORT-BILD / PLATZHALTER -->
  <div class="std-area__media std-area__anim std-area__anim--d1"
       data-img-url="/assets/img/104c104b-4468-47e7-ec73-de185aceb900.jpg">

    <!-- Bild (wird nur eingeblendet wenn area_img_url gesetzt) -->
    <img src="" alt="Standort von SONORING DORMED im Kieler Wissenschaftspark" loading="lazy" style="display:none;">
    ...
    <div class="std-area__media-info">
      <div class="std-area__media-location">
        ...
        <span class="std-area__media-location-coords">54.3233° N · 10.1228° E</span>
      </div>
  ...
  <div class="std-area__split std-area__anim std-area__anim--d2">
      ...
      <ul class="std-area__services">
        ...
        <li class="std-area__service">
          ...
          <div class="std-area__service-body">
            ...
            <div class="std-area__service-desc">Wartung, Reparaturen und Einweisungen werden direkt aus Kiel betreut — ohne Umweg über zentrale Hotlines.</div>
          </div>
    ...
    <div class="std-area__info">
      ...
      <ul class="std-area__info-list">
        <li class="std-area__info-item">
          ...
          <div>
            ...
            <div class="std-area__info-value">A215 · Anbindung an A7 / A21</div>
          </div>
        </li>
        <li class="std-area__info-item">
          ...
          <div>
            ...
            <div class="std-area__info-value">Parkplätze im Wissenschaftspark</div>
          </div>
        </li>
        <li class="std-area__info-item">
      ...
      <div class="std-area__info-highlight">
        ...
        <div class="std-area__info-highlight-text">Als einziger Ultraschall-Spezialist nördlich der Elbe reisen wir auch regelmäßig für Service-Termine in ganz Schleswig-Holstein.</div>
      </div>
    </div>
  ...
  <a href="/standorte/digitale-sonothek" class="std-area__digital std-area__anim std-area__anim--d3">
    ...
    <div class="std-area__digital-left">
      ...
      <p class="std-area__digital-desc">Wir führen Sie per Live-Video-Call durch unsere Sonothek in Kiel. Sie entscheiden, welche Geräte wir zeigen — direkt aus Ihrer Praxis, ohne Anfahrt.</p>
...
<div class="std-ct__wrap">
  <div class="std-ct__inner">
    ...
    <div class="std-ct__header" id="std-ct-hdr">
      ...
      <h2 class="std-ct__h2">So finden Sie uns in <span>Kiel</span></h2>
    </div>
    ...
    <div class="std-ct__layout">
      ...
      <div class="std-ct__map-wrap" id="std-ct-map">
        ...
        <div class="std-ct__fallback" id="std-ct-fallback">
          ...
          <p class="std-ct__fallback-addr">Maria-Merian-Straße 9, 24145 Kiel</p>
          <a href="https://maps.google.com/?q=Maria-Merian-Straße+9+24145+Kiel" target="_blank" rel="noopener" class="std-ct__fallback-btn">
        ...
        <textarea id="std-ct-iframe-html" style="display:none;" aria-hidden="true"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2135.971196000124!2d10.155006730315689!3d54.281082713569845!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47b25725c65fbd6f%3A0x60c66d43f586d3eb!2sIhre%20Ultraschall%20Spezialisten%20-%20SONORING%20DORMED!5e0!3m2!1sde!2sde!4v1776535140918!5m2!1sde!2sde" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></textarea>

        <div class="std-ct__map-footer">
          <span class="std-ct__map-address-short">Maria-Merian-Straße 9, 24145 Kiel</span>
          <a href="https://maps.google.com/?q=Maria-Merian-Straße+9+24145+Kiel" target="_blank" rel="noopener" class="std-ct__map-link">
            In Google Maps öffnen
            <svg viewBox="0 0 24 24">
              <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>
              <polyline points="15 3 21 3 21 9"/>
      ...
      <div class="std-ct__contact-panel" id="std-ct-panel">
        ...
        <div class="std-ct__cblock">
          ...
          <span class="std-ct__cblock-sub">24145 Kiel</span>
        </div>
